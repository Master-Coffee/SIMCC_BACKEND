...
# ● incite_lists_word_researcher_db
def incite_lists_word_researcher_db(_researcher_id, incite_program_id, _dep_id):

    # INCITE_program_id filter only if hasn't researcher_id

    researcher_id = ""
    dep_id = ""
    INCITE_program_id = incite_program_id

    if INCITE_program_id is None:
        INCITE_program_id = ""
    ...
    elif INCITE_program_id:
        filter_incite_program = f"""
        JOIN
                incite_graduate_program_researcher igpr ON
                        b.researcher_id = igpr.researcher_id
        WHERE igpr.incite_graduate_program_id = '{INCITE_program_id}'
        """
