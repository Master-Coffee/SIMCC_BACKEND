...
# HERE /ResearcherData/DadosGerais
...
# ★ InciteResearcherData/DadosGerais
@researcherDataRest.route("/InciteResearcherData/DadosGerais", methods=["GET"])
def InciteDadosGerais():
    year = request.args.get("year")
    incite_program_id = request.args.get("incite_program_id")
    dep_id = ""
    lista = researcherSQL.incite_generic_data(year, incite_program_id, dep_id)
    return jsonify(lista)
